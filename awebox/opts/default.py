...
def set_default_options(default_user_options, help_options):
    ...
    default_options_tree = [
        ...
        ('nlp',  'cost',             None, 't_f_wear',     0,                     ('weighting parameter for the t_f_wear objective, COMPLETELY AT THE WRONG PLACE', None), 't'),
        ...
        ('solver',  'cost',             't_f_wear',         0,      0.,         ('starting cost for t_f_wear objective', None),'s'),
